...
class ActivationCodesModel extends \Model\BaseStalkerModel {

    public function __construct() {
        parent::__construct();
    }

    public function getActivationCodesRowsList($incoming = array(), $all = FALSE) {
        if ($all) {
            $incoming['like'] = $incoming['where'] = array();
        }
        return $this->getActivationCodesList($incoming, TRUE);
    }

    public function getActivationCodesList($param, $counter = FALSE) {
    ...
    public function updateActivationCodes($params, $where){
        if (!is_array($where)) {
